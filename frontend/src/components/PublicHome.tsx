...
export default function PublicHome({ onOpenLogin, onOpenRegister }: PublicHomeProps) {
      ...
      <section className="hero">
        <div className="hero-content">
          ...
          <p className="hero-subtitle">
            Plateforme d'apprentissage et de développement parental
          </p>
      ...
      <section className="cta-section">
        <div className="cta-container">
          ...
          <p className="cta-description">
            Rejoignez des centaines de parents qui utilisent déjà nos outils pour accompagner
            le développement de leurs enfants.
          </p>
          <button onClick={onOpenRegister} className="cta-button">
